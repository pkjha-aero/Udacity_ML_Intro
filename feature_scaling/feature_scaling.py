...
# Remove NaN
#finance_features = [[float(data_dict[person]["salary"]), float(data_dict[person]["exercised_stock_options"])] for person in data_dict.keys() if data_dict[person]["salary"] != "NaN"]
finance_features = [[float(data_dict[person]["salary"]), float(data_dict[person]["exercised_stock_options"])] for person in data_dict.keys() if data_dict[person]["salary"] != "NaN" and data_dict[person]["exercised_stock_options"] != "NaN"]
